...
from train_testWB import main

parser = argparse.ArgumentParser(description='Train prototypical networks')

default = 'new_dataset'
# data args
parser.add_argument('--data.dataset', type=str, default='new_dataset', metavar='DS',
                        help="data set name (default: new_datatset)")
#parser.add_argument('--data.data_dir', type=str, default='new_dataset',required=True, metavar='DIR',
                        #help="directory containing the dataset")
parser.add_argument('--data.split', type=str, default='new_split', metavar='SP',
                        help="split name (default: new_split)")
#parser.add_argument('--data.new_split', type=str, default='new_split', metavar='SP',
...
# model args
parser.add_argument('--model.model_name', type=str, default='protonet_conv', metavar='MODELNAME',
                        help="model name (default: protonet_conv)")
parser.add_argument('--model.x_dim', type=str, default='1,28,28', metavar='XDIM',
                        help="dimensionality of input images (default: '1,28,28')")
parser.add_argument('--model.hid_dim', type=int, default=224, metavar='HIDDIM',
                        help="dimensionality of hidden layers (default: 64)")
parser.add_argument('--model.z_dim', type=int, default=224, metavar='ZDIM',
